    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'Error logging out!.Try After some time');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', type === 'data' ? 'Updated details Successfully' : 'Updated password Successfully'); //location.reload(true);
          }
  ...
  function () {
    ...
    _regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); //we are changing btn name while updating pwd
          ...
          case 7:
            ...
            document.querySelector('.btn--save-password').textContent = 'Save password'; //we are resetting the input values.
